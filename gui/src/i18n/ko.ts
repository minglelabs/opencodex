...
export const ko: Record<TKey, string> = {
  ...
  "nav.agentGraph": "에이전트 그래프",
  "agentGraph.title": "에이전트 그래프",
  "agentGraph.subtitle": "실행 중인 스레드와 위임된 에이전트를 하나의 실시간 워크플로우에서 확인합니다.",
  "agentGraph.refresh": "새로고침",
  "agentGraph.refreshing": "새로고침 중…",
  "agentGraph.updated": "업데이트",
  "agentGraph.liveWorkflow": "실시간 워크플로우",
  "agentGraph.polling": "3초마다 폴링",
  "agentGraph.thread": "스레드",
  "agentGraph.agentDetail": "에이전트 상세",
  "agentGraph.running": "실행 중",
  "agentGraph.waiting": "대기",
  "agentGraph.completed": "완료",
  "agentGraph.error": "오류",
  "agentGraph.threads": "스레드",
  "agentGraph.agents": "에이전트",
  "agentGraph.tokens": "토큰",
  "agentGraph.turns": "턴",
  "agentGraph.elapsed": "경과 시간",
  "agentGraph.model": "모델",
  "agentGraph.role": "역할",
  "agentGraph.session": "세션",
  "agentGraph.recentError": "최근 오류",
  "agentGraph.noError": "최근 오류 없음",
  "agentGraph.selectNode": "노드를 선택하면 세션 상세 정보를 확인할 수 있습니다.",
  "agentGraph.empty": "아직 에이전트 활동이 없습니다.",
  "agentGraph.loadFailed": "에이전트 그래프를 불러오지 못했습니다.",
  "agentGraph.tokensIn": "입력",
  "agentGraph.tokensOut": "출력",
